    ...
    return (
        <header className={HeaderCss.header}>
            ...
            <div className={HeaderCss.headerSearchIcon}>
                <img className={HeaderCss.headerSearchIconImg} src={searchIcon} alt="search icon" />
            </div>
            <div className={HeaderCss.headerNotificationIcon}>
                <img className={HeaderCss.headerNotificationIconImg} src={notificationIcon} alt="Notification icon" />
            </div>
            ...
            <div className={HeaderCss.headerUserPhotoMedia}>
                <figure className={HeaderCss.headerUserPhotoMediaWrapper}>
                    <img className={HeaderCss.headerUserPhotoMediaImg} src={userPhoto} alt="profile picture" />
                </figure>
            </div>
        </header>
    )
