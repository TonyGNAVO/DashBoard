    ...
    return (
        <Link to={`/${link}`}>
            <div
                className={
                    active
                        ? `${MenuItemCss.menuItem} ${MenuItemCss.menuItemActive}`
                        : `${MenuItemCss.menuItem}`
                }
            >
                ...
                <span className={MenuItemCss.menuItemText}>
                    <span
                        className={
                            active
                                ? `${MenuItemCss.menuItemTextWrapper} ${MenuItemCss.menuItemTextWrapperActive}`
                                : `${MenuItemCss.menuItemTextWrapper}`
                        }
                    >
                        {text}
                    </span>
