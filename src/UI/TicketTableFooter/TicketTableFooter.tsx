    ...
    return (
        <div className={Css.ticketTableFooter}>
            ...
            <div className={Css.ticketTableFooterWrapper}>
                <p className={Css.ticketTableFooterRowPerPage}>
                    Rows per page
                </p>
                ...
                <figure className={Css.ticketTableFooterRowPerPageMedia}>
                    <img className={Css.ticketTableFooterRowPerPageMediaImg} src={numPage} alt="Icon to choose the number of item per page" />
                </figure>
                <div className={Css.ticketTableFooterElement}>
                    <p className={Css.ticketTableFooterElementValue}>{`${footer.first}-${footer.last} of ${footer.number}`}</p>
                    <figure className={`${Css.ticketTableFooterElementMedia} ${Css.ticketTableFooterElementLeftMedia}`} >
                        <img className={Css.ticketTableFooterElementMediaImg} src={left} alt="go to the previous page" />
                    </figure>
                    <figure style={{ display: footer.right ? "flex" : "none" }} className={Css.ticketTableFooterElementMedia} onClick={e => dispatch(nextPage())}>
                        <img className={Css.ticketTableFooterElementMediaImg} src={right} alt="go to the next page" />
                    </figure>
                </div>
            </div>
